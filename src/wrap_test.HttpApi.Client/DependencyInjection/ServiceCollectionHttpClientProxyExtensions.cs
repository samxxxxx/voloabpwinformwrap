...
namespace Microsoft.Extensions.DependencyInjection
{
    public static class ServiceCollectionHttpClientProxyExtensions
    {
        ...
        /// Default value: All.
        /// </param>
        public static IServiceCollection AddWrapHttpClientProxies(
            ...
            ApplicationServiceTypes applicationServiceTypes = ApplicationServiceTypes.All)
        {
            ...
            {
                services.AddWrapHttpClientProxy(
                    serviceType,
        ...
        /// </param>
        public static IServiceCollection AddWrapHttpClientProxy<T>(
            [NotNull] this IServiceCollection services,
            [NotNull] string remoteServiceConfigurationName = RemoteServiceConfigurationDictionary.DefaultName,
            bool asDefaultService = true)
        {
            return services.AddWrapHttpClientProxy(
                typeof(T),
                remoteServiceConfigurationName,
                asDefaultService
            );
        ...
        /// </param>
        public static IServiceCollection AddWrapHttpClientProxy(
            [NotNull] this IServiceCollection services,
            [NotNull] Type type,
            [NotNull] string remoteServiceConfigurationName = RemoteServiceConfigurationDictionary.DefaultName,
            bool asDefaultService = true)
        {
            ...
            var interceptorType = typeof(WrapDynamicHttpProxyInterceptor<>).MakeGenericType(type);
